            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="card text-center card-product custom-image-container">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-product__price">TND {{ $product->Prix }}</p>
                    </div>
                </div>
            </div>
            @endforeach
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="card text-center card-product custom-image-container">
                        ...
                        <div class="card-body">
                            <p>{{ $product->category_name }}</p>
                            <h4 class="card-product__title"><a href="#">{{ $product->Name }}</a></h4>
                            <p class="card-product__price">${{ $product->Prix }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://helloweb.com" target="_blank">HelloWeb</a>
